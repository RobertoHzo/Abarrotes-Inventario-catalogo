			...
			<div class="row">
				<div class="col-md-12">
					<div class="dropdown product-filters" style="text-align: center;">
						<button class="btn btn-danger btn-lg dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-offset="auto">Categorias
						</button>
