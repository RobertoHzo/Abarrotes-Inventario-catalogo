...
<body>
    ...
    //Para imprimir el id del user obtenido del session
     ...
     VALUES (:Name,:Descr,:Sale, :Cost_, :Unit,:Quan,:Photo_, now(),:Supp,:Cat,{$userid});");
        ...
        WHERE product_id =:id");
            ...
            if ($txtImage != "") {
                ...
                if (isset($product["photo"]) && $product["photo"] != "image.jpg" && file_exists("../imagenes/img_productos/" . $product["photo"])) {
                    unlink("../imagenes/img_productos/" . $product["photo"]);
                }
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="Tablex" aria-label="Product Information Table">
                                        <thead>
                                            <tr>
