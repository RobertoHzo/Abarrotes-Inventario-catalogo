                    ...
                    <div class="col-md-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form role="form"  method="post"> <!--action y post -->
                                        ...
                                        <?php if($query -> rowCount() > 0)   { 
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <!-- <td style="text-align:center;"><button class="btn btn-primary"><i class="fa fa-check-square"></i></button></td>                                                             -->
                                                    <!-- <td><button class="btn btn-danger" name="eliminar" onclick="return confirm('¿Estas seguro de eliminar?')"><i class="fa fa-eraser"></i> </button></td>  -->
                                            </tr>
